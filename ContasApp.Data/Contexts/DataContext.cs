...
namespace ContasApp.Data.Contexts
{
    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Data Source=SQL8005.site4now.net;Initial Catalog=db_a99ef7_bdcontasapp;User Id=db_a99ef7_bdcontasapp_admin;Password=AH091306\r\n");
        }
